            ...
            <div className="head-title">
                <div className="left">
                    ...
                    <ul className="breadcrumb">
                        ...
                        <li><i className='bx bx-chevron-right'></i></li>
                        <li>
                            <Link className="active" >{MaKH}</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="container-edit">
                    <div className="form-row">
                        <div className="form-group col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputHoGV" placeholder="Điền mã khách hàng ..." value={MaKH} onChange={(event) => onChangeInputSL(event, SetMaKH)} onBlur={() => checkdulieu(MaKH, SetCheckdulieuMa)} readOnly />
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-12 formbtn" id="btsubmit">
                            <div><button className="btn btn-primary btn-sm" type="button" onClick={() => handleEditCustomer()}>Lưu dữ liệu</button></div>
                        </div>
